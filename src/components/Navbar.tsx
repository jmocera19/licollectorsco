        ...
        <div className="flex justify-between items-center py-4 md:py-6">
          ...
          <div className="flex-shrink-0 flex items-center cursor-pointer mr-6 z-50">
            <a href="#" className="flex items-center gap-4">
              <img src={logo} alt="Logo" className="h-16 md:h-20 w-auto object-contain drop-shadow-[0_0_15px_rgba(212,175,55,0.2)]" />
              <span className="hidden sm:block text-gold text-xl md:text-2xl font-serif font-bold tracking-tight text-shadow-sm">
